 ...
 */
public class TaggedBlogCountMapper extends Mapper<LongWritable, Text, Text, LongWritable> {
	...
	public void map(LongWritable line, Text data, Context context) throws IOException, InterruptedException {
		...
		context.write(new Text("a"), new LongWritable(Integer.parseInt(strings[2])));
	}
